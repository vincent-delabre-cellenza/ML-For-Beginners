...
* الیزا، یک "چتر‌بات" اولیه، می‌توانست با مردم گفتگو کند و به عنوان یک "درمانگر" ابتدایی عمل کند. در درس‌های NLP بیشتر درباره الیزا خواهید آموخت.
    ...
    ![الیزا، یک بات](../../../../1-Introduction/2-history-of-ML/images/eliza.png)
